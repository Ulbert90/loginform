...
<body>
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900 shadow-md">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="game.php" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="img/arc.png" class="h-8" alt="Flowbite Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">WarN.E.E.T</span>
            </a>
